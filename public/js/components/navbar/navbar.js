        ...
        <div class="p-8">
            ...
            <div class="flex flex-col gap-6">
                ...
                ${data.links.map(link => `
                    <a
                        href="${link.href}"
                        class="text-white/80 font-medium tracking-wide text-md hover:text-amber-400 hover:translate-x-2 transition-all duration-300 flex items-center gap-3"
                    >
                ...
                <a
                    href="javascript:void(0)"
                    class="enquire-now-cta mt-6 px-6 py-3.5  bg-yellow-500 text-white text-center font-semibold hover:bg-yellow-400 transition-colors  font-semibold rounded-xl hover:from-amber-400 hover:to-amber-500 hover:scale-105 transition-all duration-300 text-sm tracking-wide shadow-lg shadow-amber-500/25"
                >
                    ${data.ctaText}
                </a>
